...
public class TourAddController {
    ...
    public static final String pathImage="D:\\project\\Travel_System\\src\\main\\webapp\\resources\\image\\";
    ...
    public String saveTour( @ModelAttribute("tour") TourEntity tour, BindingResult result, Model model,
                             MultipartFile file){
        byte[] bytes = new byte[0];
        int id =(int)Math.random()*1000;
        String path = pathImage+id + ".png";
        PhotoEntity photoEntity = new PhotoEntity();
        photoEntity.setFilePath(path);
